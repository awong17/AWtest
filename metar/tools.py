...
def main(start_date,end_date,states):
    """Our main method"""
    # timestamps in UTC to request data for
    startts = datetime.datetime(start_date[0], start_date[1], start_date[2])
    endts = datetime.datetime(end_date[0], end_date[1], end_date[2])
